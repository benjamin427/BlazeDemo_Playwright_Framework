...
import { blazedemo_rest_password } from '../password_reset/page_object/password_reset';

test("Enter the expected email text format in the text field ", async({page}) => {
    const resetPassword = new blazedemo_rest_password(page)
